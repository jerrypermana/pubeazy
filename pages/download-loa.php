...
<head>
    ...
    <title>Letter Of Accepted</title>
...
<body>
    ...
    $paper_id = $_GET['id'];
    $query = "SELECT p.paper_id,p.judul, p.abstrak, p.v_paper,p.id_presenter,pre.member_id,pre.realname, p.file_paper,tp.biaya_conf,tp.transfer_id,tp.v_transfer, 
  ...
  location.replace("' . $base_url . '/index.php?p=dashboard")</script>';
    ...
    <table class="heading" style="width:100%;">
        ...
        <tr>
            <td>
                <center>
                    <p class='header'>Letter Of Accepted</p>
                </center>
            </td>
        </tr>
        <tr>

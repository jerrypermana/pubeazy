...
if ($_SESSION['group_session'] == 'presenter') {
    ...
    conf.konferensi_id,conf.nama_konferensi,conf.start_date,conf.end_date,conf.penyelenggara, mr.nama_ruang,pre.instansi,pre.member_id,p.input_date,p.v_akhir,
